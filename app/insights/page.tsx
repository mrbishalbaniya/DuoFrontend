          ...
          <div className="mb-8 flex gap-3 overflow-x-auto pb-2 hide-scrollbar">
            {matches.map((match) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold transition-all whitespace-nowrap ${selectedMatch?.id === match.id ? "bg-primary text-white shadow-lg" : "bg-white text-on-surface-variant hover:bg-surface-container-low"}`}
              >
        ...
        {m && (
          <>
              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="relative w-64 h-64 flex items-center justify-center">
                  <svg className="w-full h-full transform -rotate-90">
                    ...
                    <defs><linearGradient id="gradient" x1="0%" x2="100%" y1="0%" y2="0%"><stop offset="0%" stopColor="var(--color-primary)"></stop><stop offset="100%" stopColor="var(--color-secondary)"></stop></linearGradient></defs>
                  </svg>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              <div className="md:col-span-7 p-8 rounded-[2rem] bg-white shadow-[0_20px_50px_rgba(33,79,199,0.03)]">
              ...
              <div className="md:col-span-5 flex flex-col gap-6">
                <div className="p-6 rounded-[2rem] bg-primary-container text-on-primary-container shadow-lg shadow-primary/10">
              ...
              <div className="md:col-span-12 p-8 rounded-[2rem] bg-white shadow-sm overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div>
                    <h4 className="font-bold text-secondary mb-3">Communication Style</h4>
            ...
            <div className="mt-12 p-8 rounded-[2rem] glass-card flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
              ...
              <Link href="/chat" className="px-8 py-4 gradient-brand-br text-white rounded-full font-bold shadow-lg shadow-primary/20 active:scale-95 transition-all">
                Start Chatting
              </Link>
            </div>
          </>
